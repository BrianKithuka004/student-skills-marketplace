...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    socketRef.current.on('unread_count', (count) => {
  ...
  }, [user, fetchUsers, scrollToBottom]);
  ...
  return (
    <div className="flex h-[calc(100vh-120px)] bg-gray-900 text-white rounded-lg overflow-hidden border border-gray-700">
